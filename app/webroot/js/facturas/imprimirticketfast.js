...
var imprimirFacturaFacturaRapidaTicket = function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            mywindow.document.write('body { margin: 0; padding: 0; font-family: Arial, sans-serif; font-size: 11px; width: 80mm; color: #000; line-height: 1.3; }');
            ...
            mywindow.document.write('th { font-size: 11px; padding: 5px 0; border-bottom: 1px solid #000; text-align: left; font-weight: bold; }');
            ...
            mywindow.document.write('.logo-contenedor { width: 100%; text-align: center; font-size: 28px; font-family: "Courier New", Courier, monospace; letter-spacing: 4px; margin-bottom: 10px; }');
            mywindow.document.write('</style></head><body>');

            mywindow.document.write('<div style="width: 100%; padding-right: 5px;">');
            ...
            mywindow.document.write('<div class="text-center"><b>' + empresa.nombre + '</b></div>');
            mywindow.document.write('<div class="text-center" style="font-size: 10px;">NIT: ' + empresa.nit + ' - ' + empresa.texto1 + '</div>');
            mywindow.document.write('<div class="text-center" style="font-size: 10px;">Resolución No. ' + resolucion.resolucion + ' de ' + resolucion.fechainicio + '</div>');
            mywindow.document.write('<div class="text-center" style="font-size: 10px;">Prefijo: ' + resolucion.prefijo + ', Rango ' + resolucion.resolucioninicia + ' al ' + resolucion.resolucionfin + '</div>');
            mywindow.document.write('<div class="text-center" style="font-size: 10px;">Vigencia Desde:' + resolucion.fechainicio + ' Hasta: ' + resolucion.fechafin + '</div>');
            mywindow.document.write('<div class="text-center"><b>REPRESENTACIÓN GRÁFICA DE FACTURA ELECTRÓNICA</b></div>');
            mywindow.document.write('<div class="text-center">' + empresa.direccion + ' - </div>');
            mywindow.document.write('<div class="text-center">Tel: ' + empresa.telefono1 + ' | E-mail: ' + empresa.email + '</div>');
            
            mywindow.document.write('<div class="separador"></div>');
            
            // --- INFO FACTURA ---
            mywindow.document.write('<div class="text-center" style="font-size: 12px;"><b>FACTURA ELECTRONICA ' + facturaF.prefijo + ' ' + facturaF.consecutivodian + '</b></div>');
            ...
            mywindow.document.write('<div class="text-center">' + fechaTexto + '</div>');
            mywindow.document.write('<div class="text-center">Emitido a la DIAN</div>');
            ...
            mywindow.document.write('<div><b>Tel:</b> ' + (cliente.telefono || '') + '</div>');
            mywindow.document.write('<div><b>Dir:</b> ' + (cliente.direccion || '') + '</div>');
            mywindow.document.write('<div><b>Orden:</b> | <b>Fecha:</b> </div>');
            mywindow.document.write('<div><b>Vendedor:</b> ' + vendedor.nombre + '</div>');
            
            // Métodos de Pago
            mywindow.document.write('<div><b>Método(s) de Pago:</b></div>');
            ...
            mywindow.document.write('<tr><th style="width:65%;">DESCRIPCIÓN</th><th class="text-center" style="width:10%;">CANT</th><th class="text-right" style="width:25%;">TOTAL</th></tr>');
            ...
            $.each(data.infoDetFact, function(k, item) {
                ...
                mywindow.document.write('<td>' + prod.descripcion + '<br><span style="font-size:10px; color:#555;">' + prod.codigo + '</span></td>');
                mywindow.document.write('<td class="text-center">' + cant + '</td>');
                mywindow.document.write('<td class="text-right">' + totalFila.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</td>');
                mywindow.document.write('</tr>');
            });
            ...
            mywindow.document.write('<tr><td class="text-right">Subtotal Prod:</td><td class="text-right">' + subtotalProd.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</td></tr>');
            mywindow.document.write('<tr><td class="text-right"><b>Subtotal:</b></td><td class="text-right"><b>' + subtotalProd.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</b></td></tr>');
            mywindow.document.write('<tr><td class="text-right">Descuento:</td><td class="text-right">0.00</td></tr>');
            mywindow.document.write('<tr><td class="text-right"><b>Total Bruto:</b></td><td class="text-right"><b>' + subtotalProd.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</b></td></tr>');
            mywindow.document.write('<tr><td class="text-right">IVA:</td><td class="text-right">' + totalIva.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</td></tr>');
            ...
            mywindow.document.write('<tr><td class="text-right"><b>Total Impuestos:</b></td><td class="text-right"><b>' + totalIva.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</b></td></tr>');
            mywindow.document.write('<tr><td class="text-right" style="font-size:12px; border-top:1px solid #000; padding-top:4px;"><b>TOTAL FACTURA:</b></td><td class="text-right" style="font-size:12px; border-top:1px solid #000; padding-top:4px;"><b>$' + totalFacturaAcumulado.toLocaleString('es-CO', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '</b></td></tr>');
            mywindow.document.write('</table>');
            
            mywindow.document.write('<div class="separador"></div>');
            
            // --- PIE DE PÁGINA ---
            mywindow.document.write('<div class="text-center" style="font-size: 9px; line-height: 1.2;">Software de facturación suministrado por Miggo Solutions S.A.S<br>NIT 901629169</div>');
            mywindow.document.write('<div class="text-center" style="font-size: 9px; line-height: 1.2;">Modalidad software adquirido desarrollador habilitado por la DIAN según concepto 013246 de 2025</div>');
            mywindow.document.write('<div class="text-center" style="font-size: 9px; line-height: 1.2;">www.miggo.com.co línea de servicio al cliente 3116871320.</div>');
