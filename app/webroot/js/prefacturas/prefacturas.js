        ...
        success: function(data) {    
            ...
            if(respuesta.resp){
                $.each(respuesta.detFact, function(idx, obj) {
                    ...
                    '<td><input type="text" name="pordtto_' + obj['Prefacturasdetalle']['id'] + '" class="form-control ttalPorDtto" id="pordtto_' + obj['Prefacturasdetalle']['id'] + '" value="' + obj['Prefacturasdetalle']['porcentaje'] + '" onblur="actualizarPorcentajeDtto(this);" disabled>&nbsp;</td>' +
                    '<td><input type="text" name="valdtto_' + obj['Prefacturasdetalle']['id'] + '" class="form-control ttalValDtto numericPrice" id="valdtto_' + obj['Prefacturasdetalle']['id'] + '" value="' + valDcto + '" onblur="actualizarValorDtto(this);" disabled>&nbsp;</td>' +
        ...
        success: function(data) {
            ...
            if(prefactura.resp != '0' && prefactura.resp != ""){
                $('#productosPrefacturas').append(
                        ...
                        '<td><input type="text" name="pordtto_' + prefactura.resp + '" class="form-control ttalPorDtto" id="pordtto_' + prefactura.resp + '" value="' + porcentajeDescuento + '" onblur="actualizarPorcentajeDtto(this);" disabled>&nbsp;</td>' +                        
                        '<td><input type="text" name="valdtto_' + prefactura.resp + '" class="form-control ttalValDtto numericPrice" id="valdtto_' + prefactura.resp + '" value="' + valorDescuento + '" onblur="actualizarValorDtto(this);" disabled>&nbsp;</td>' +                       
