...
*                                                                              *
*******************************************************************************/
function FPDF($param =null, $orientation='P', $unit='mm', $format='A4')
{
    
    /**Adicionado por Margarita Hoyos**/        
    if($param == null)
    {
        $orientation='P';
        $unit='mm'; 
    ...
    {
        $orientation = is_array($orientation) ? (empty($orientation['orientation']) ? 'P' : $orientation['orientation']) : $orientation;
        $unit = is_array($unit) ? (empty($unit['unit']) ? 'mm' : $unit['unit']) : $unit;
        $format = is_array($format) ? (empty($format['format']) ? 'A4' : $format['format']) : $format;
    }
    /** Termina **/
