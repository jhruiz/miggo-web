...
<?php echo $this->Form->create('Publicidadmovile', array('type' => 'file')); ?>
    <div class="x_title">
        <h2><?php echo __('Imágenes Cabecera'); ?></h2>
    </div>  
	<fieldset>
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mask col-md-3">
                                                                        <?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-trash-o fa-lg', 'title' => 'Eliminar')), array('action' => 'delete', $pubMovil[$k]['Publicidadmovile']['id'], '1'), array('escape' => false)) ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
