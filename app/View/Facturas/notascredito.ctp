        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped table-hover table-condensed">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('consecutivodian', 'Consecutivo FE'); ?></th>
                    ...
                    <tr>
                    <td>
                        <?php if ($factura['Factura']['consecutivonc'] > 0) { ?>
                            <i class="fa fa-spinner fa-pulse fa-lg fa-fw text-primary" style="display: none;" id="spinner_<?php echo($factura['Factura']['id']); ?>"></i>
                            <i class="fa <?php echo($faType);?> fa-lg" title="Reenviar nota crédito" style="cursor: pointer;" data-id="<?php echo($factura['Factura']['id']); ?>" id="checksyncNC_<?php echo($factura['Factura']['id']); ?>" onclick="obtenerNCDian(<?php echo($factura['Factura']['id']); ?>)"></i> 
                        <?php } ?>
                    </td>
                    <td><?php echo h( $factura['Factura']['consecutivonc'] != '' ? $factura['Factura']['consecutivonc'] : $factura['Factura']['consecutivodv']); ?>&nbsp;</td>
