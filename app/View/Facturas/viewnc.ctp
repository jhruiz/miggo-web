...
<br>
  <div class="x_panel"> 
    ...
    <input type="hidden" id="dianQRStr" value="<?php echo $infoFact['Factura']['dianNCQRStr'];?>">
    ...
    <div id="dvFacturas" style="margin:0px; width:100%; font-family:sans-serif; font-size:15px;">    
        ...
        <?php if($infoFact['Factura']['factura']){ ?>
            <div style="width:100%; float:left; margin:0px; margin-top:10px;" align="center">
                <div><b><?php echo __($infoResolucionNC['Resolucionfactura']['nombredocumento'] . ' ' . $infoFact['Factura']['prefijo'] . ' ' . $consecutivoNC) ?></b></div> 
        ...
        <?php }else{?>
            <div style="width:100%; float:left; margin:0px" align="center"><b><?php echo __($infoResolucionNC['Resolucionfactura']['nombredocumento'] . ' ' . $infoResolucionNC['Resolucionfactura']['prefijo'] . ' ' . $consecutivoFact) ?></b></div>  
