...
<section class="main row">
    ...
    <div class="col-md-6">   
        <input type="hidden" id="precioVenta" value="<?php echo $vlrAntesImp;?>">
...
<div class="container-fluid">
    <button  id="btn_guardarEst" class="btn btn-primary center-block" onclick="agregarProductoFacturaClienteNuevo()">Agregar</button>
</div>
