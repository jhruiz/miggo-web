...
<div class="depositos form container-fluid" style="padding: 20px;">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3">
            <h3 class="card-title mb-0"><b><i class="fa fa-university"></i> <?php echo __('Editar Bodega'); ?></b></h3>
        </div>
        ...
        <div class="card-footer bg-white text-right py-3">
            <?php echo $this->Form->submit('Actualizar Bodega', array('class' => 'btn btn-primary btn-lg px-5 shadow-sm')); ?>
        </div>
    </div>
