...
<?php echo $this->Form->create('Deposito', array('type' => 'post', 'class' => 'form-inline')); ?>
	<fieldset>
		<legend><h2><b><?php echo __('Agregar Bodega'); ?></b></h2></legend>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input name="data[Deposito][fecharesolucion]" class="date form-control" placeholder="Fecha de Resolución" type="text" id="cumpleanios" autocomplete="off">
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('resolucioninicia', array('label' => '', 'class' => 'form-control', 'placeholder' => 'Número Inicial de Resolución', "autocomplete" => "off")); ?>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('prefijo', array('label' => '', 'class' => 'form-control', 'placeholder' => 'Prefijo de la Bodega')); ?>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('nota', array('label' => '', 'class' => 'form-control', 'placeholder' => 'Agregar nota para la Bodega')); ?>
                    </div>
                </div>
	</fieldset><br><br>
